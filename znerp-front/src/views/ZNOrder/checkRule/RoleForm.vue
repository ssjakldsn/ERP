    ...
    >
      ...
      <el-form-item label="执行动作" prop="action">
				<el-radio-group v-model="formData.action">
					<el-radio :value="1">订单留在（待审核）需要人工来处理</el-radio>
					<el-radio :value="2">订单移入（待处理）</el-radio>
				</el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="产品SKU" prop="skuList">
        <el-input v-model="formData.remark" placeholder="请输入" type="textarea" rows="6" />
				<p>输入产品SKU,多个请用 回车 换行分隔</p>
      </el-form-item>
    </el-form>
    <template #footer>
